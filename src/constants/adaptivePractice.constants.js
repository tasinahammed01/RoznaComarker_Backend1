...
const ADAPTIVE_PRACTICE_PROMPT_VERSION = 'adaptive-practice-v3-question-sets';
const ADAPTIVE_PRACTICE_MIN_QUESTIONS = 1;
const ADAPTIVE_PRACTICE_DEFAULT_QUESTIONS = 3;
const ADAPTIVE_PRACTICE_MAX_QUESTIONS = 3;
