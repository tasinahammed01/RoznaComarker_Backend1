...
describe('PDF browser lifecycle and queue', () => {
  ...
  afterEach(async () => { await manager._test.reset(); delete process.env.PDF_MAX_CONCURRENT_RENDERS; delete process.env.PDF_RENDER_QUEUE_LIMIT; delete process.env.PUPPETEER_EXECUTABLE_PATH; });
